		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (authenticate(getUsername(), getPassword())) {
					// 인증 성공
					JOptionPane.showMessageDialog(LoginDialog.this, "안녕하세요 " + getUsername() + "님, 로그인에 성공하셨습니다.",
					...
					// 인증 실패
					JOptionPane.showMessageDialog(LoginDialog.this, "아이디 또는 비밀번호가 잘못되었습니다.", "로그인",
